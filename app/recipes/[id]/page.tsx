...
export default async function RecipePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!recipe) notFound()
  await supabase.from('recently_viewed').upsert({ user_id: user.id, recipe_id: id, viewed_at: new Date().toISOString() }, { onConflict: 'user_id,recipe_id' })
